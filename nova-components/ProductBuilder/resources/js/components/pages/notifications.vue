                        ...
                        <template slot="table-row" slot-scope="props">
                            ...
                            <span v-else-if="props.column.field == 'action'">
                                ...
                                <span>
                                    ...
                                    <router-link :to="{path: 'notification-settings/edit/'+props.row.id }" class="cursor-pointer text-70 hover:text-primary mr-3" >
    ...
    export default {
        ...
        methods: {
            ...
            confirmDelete() {
                ...
                Nova.request().post('/nova-vendor/ProductBuilder/destroyNotification',formData);
            ...
            getNotifications(){
                Nova.request().get(`/nova-vendor/ProductBuilder/getNotifications`).then((response) => {
                    this.rows = response.data.notification;
                });
        ...
        async created(){
            await axios.get(`/nova-vendor/ProductBuilder/getNotifications`).then((response) => {
                this.rows = response.data.notification;
            });

            if(!this.resourceName){
                this.resourceName = 'notification';
            }
            this.breadcrumbs=[
