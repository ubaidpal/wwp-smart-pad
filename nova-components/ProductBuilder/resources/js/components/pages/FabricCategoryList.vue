        ...
        <div class="flex" style="">
            ...
            <div class="flex-no-shrink ml-auto">
                <router-link :to="{
                            name: 'create',
                            params: {
                                resourceName: 'fabric-categories'
                            }
                        }" class="btn btn-default btn-primary">Create Fabric Category</router-link>
            </div>
        </div></div>
                    ...
                    >
                        <template slot="table-row" slot-scope="props">
                            ...
                            <span v-else-if="props.column.field == 'action'">
                                <span>
                                    <router-link :to="{name: 'edit',params: {resourceName:'fabric-categories',resourceId:props.row.id}}" class="cursor-pointer text-70 hover:text-primary mr-3" >
...
<script>
  ...
  export default {
        ...
        data: () => ({
            ...
            deleteResource:0,
            headers:{
                heading:'Fabric Category Listing'
            },
            columns: [
                {
                    label: 'ID',
        ...
        methods: {
            ...
            getCategories(){
                Nova.request().get(`/nova-vendor/ProductBuilder/getFabricCategories`).then((response) => {
        ...
        async created(){
          await axios.get(`/nova-vendor/ProductBuilder/getFabricCategories`).then((response) => {
              this.rows = response.data.categories;
          });
        }
    }
