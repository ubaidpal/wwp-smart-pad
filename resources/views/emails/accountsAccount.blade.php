                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    ...
                                                    <h4>Welcome to {!! ucfirst($username) !!}</h4>

                                                    <p class="m-b-5">Please click the following URL  and use flowing credential to activate your account :</p>
                                                    <p class="m-b-5">Your Email: {!! ucfirst($email) !!} :</p>
                                                    <p class="m-b-5">Your Username: {!! ucfirst($username) !!}:</p>
                                                    <p class="m-b-5"> Your Password: {!! ucfirst($password) !!} :</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel">
