...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBgLOeQGeVi06XzzORwhZLhgG9mICxBlXg&libraries=places"></script>

    <!-- Styles -->
    <link rel="stylesheet" href="{{ mix('app.css', 'vendor/nova') }}">
    <style>
        /*Smart Pad Pro Button Colors*/
        .spp-delete{
            color: red;
        }
        .spp-save{
            ...
            <div class="content">
                ...
                <div data-testid="content" class="px-view py-view mx-auto">
                    ...
                    <p class="mt-8 text-center text-xs text-80">
                        <a href="#" class="text-primary dim no-underline">{{env('APP_NAME')}}</a>
