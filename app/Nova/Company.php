...
class Company extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Website')->rules('url')->sortable(),
            Text::make('Email')->rules('required', 'email', 'max:255')->creationRules('unique:companies,email'),
    ...
    {
        $accounts = Accounts::with('companies')->all();
        dd($accounts);
